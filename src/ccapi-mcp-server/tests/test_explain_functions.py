...
class TestExplainFunctions:
    ...
    def test_generate_explanation_dict(self):
        ...
        result = _generate_explanation(
            content, 'Test Context', 'create', 'detailed', 'Test Intent'
        )
    ...
    def test_explain_dict_summary_format(self):
        ...
        data = {'nested_dict': {'a': 1, 'b': 2}, 'nested_list': ['item1', 'item2']}
    ...
    def test_explain_dict_private_keys(self):
        ...
        data = {
            'public_key': 'value',
            '_private_key': 'private_value',  # pragma: allowlist secret
    ...
    def test_explain_dict_empty_tags(self):
        ...
        data = {'BucketName': 'test-bucket', 'Tags': []}
        result = _explain_dict(data, 'detailed')
    ...
    def test_explain_dict_non_dict_tags(self):
        ...
        data = {
            'BucketName': 'test-bucket',
            'Tags': ['not-a-dict', {'Key': 'valid', 'Value': 'tag'}],  # pragma: allowlist secret
        }
        result = _explain_dict(data, 'detailed')

        assert 'Tags:' in result
        # Should handle mixed content gracefully  # pragma: allowlist secret
