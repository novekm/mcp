...
class TestErrors:
    ...
    async def test_handle_other(self):
        ...
        mapped = handle_aws_api_error(error)
        assert mapped.message.startswith('An error occurred')  # type: ignore
