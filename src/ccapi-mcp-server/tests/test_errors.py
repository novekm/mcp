...
class TestErrors:
    ...
    async def test_handle_incomplete_signature(self):
        ...
        mapped = handle_aws_api_error(error)
        # pyright: ignore[reportAttributeAccessIssue]
        assert mapped.message.startswith('Incomplete signature')
    ...
    async def test_handle_invalid_action(self):
        ...
        mapped = handle_aws_api_error(error)
        # pyright: ignore[reportAttributeAccessIssue]
        assert mapped.message.startswith('Invalid action')
    ...
    async def test_handle_invalid_client_token(self):
        ...
        mapped = handle_aws_api_error(error)
        # pyright: ignore[reportAttributeAccessIssue]
        assert mapped.message.startswith('Invalid client token id')
    ...
    async def test_handle_not_authorized(self):
        ...
        mapped = handle_aws_api_error(error)
        # pyright: ignore[reportAttributeAccessIssue]
        assert mapped.message.startswith('Not authorized')
