...
class TestTools:
    ...
    async def test_get_resource(self, mock_get_aws_client):
        ...
        mock_cloudcontrol_client = MagicMock(
            get_resource=mock_get_resource_return_value)
    ...
    async def test_update_resource(self, mock_get_aws_client):
        ...
        mock_cloudcontrol_client = MagicMock(
            update_resource=mock_update_resource_return_value)
        mock_get_aws_client.return_value = mock_cloudcontrol_client
    ...
    async def test_create_resource(self, mock_schema_manager, mock_get_aws_client):
        ...
        mock_cloudcontrol_client = MagicMock(
            create_resource=mock_create_resource_return_value)
        mock_get_aws_client.return_value = mock_cloudcontrol_client

        # Mock schema manager
        mock_schema_instance = MagicMock()
        mock_schema_instance.get_schema = AsyncMock(
    ...
    async def test_delete_resource(self, mock_get_aws_client):
        ...
        mock_cloudcontrol_client = MagicMock(
            delete_resource=mock_delete_resource_return_value)
        mock_get_aws_client.return_value = mock_cloudcontrol_client
    ...
    @patch('awslabs.ccapi_mcp_server.iac_generator.create_template')
    @patch('awslabs.ccapi_mcp_server.iac_generator.get_aws_client')
